...
public class Gang {
    ...
    public void letsRob(Building[] buildings){
        ...
        if(isSuccessfulRobbery()){
            System.out.println("The gang decided to rob the following items from the "+buildings[randomBuildingIndex].getName()+":");
    ...
    private boolean isSuccessfulRobbery(){
        ...
        if(randomNumber >= sumarizedSuccessChange)  return false;
        return true;
    }
}
